...
import { Plus, Search, Building2, MapPin, Camera, PieChart, Database, Upload, FileText, Menu, Moon, Sun, ChevronRight, X, Zap, Sun as SunIcon, Battery, Calendar, HardHat, Sparkles, LogOut, Ruler, Layers, Navigation, Briefcase, AlertTriangle, CalendarDays } from 'lucide-react';
              ...
              >
                  ...
                  <div className="space-y-4 pt-5 border-t border-slate-50 dark:border-slate-700">
                    ...
                    <div>
                      <div className="flex justify-between items-center text-xs mb-1.5">
                        ...
                        <span className="font-bold text-slate-700 dark:text-slate-300">{budgetProgress.toFixed(0)}%</span>
                      </div>
                      <div className="w-full bg-slate-100 dark:bg-slate-700 rounded-full h-2 overflow-hidden">
                        <div 
                ...
                <div className="bg-slate-50/50 dark:bg-slate-700/30 px-6 py-4 border-t border-slate-100 dark:border-slate-700 flex justify-between items-center backdrop-blur-sm">
                  <div className="flex flex-col">
                    <span className="text-[10px] text-slate-400 dark:text-slate-500 font-bold uppercase tracking-wider mb-1">Inicio</span>
                    <span className="text-sm font-bold text-slate-700 dark:text-slate-300 flex items-center gap-1">
                      <CalendarDays className="w-3.5 h-3.5 text-[#0047AB] dark:text-blue-400" />
                      {formatDate(project.startDate)}
                    </span>
                  </div>
                  <div className="flex flex-col items-end">
                    <span className="text-[10px] text-slate-400 dark:text-slate-500 font-bold uppercase tracking-wider mb-1">Fin Estimado</span>
                    <span className="text-sm font-bold text-slate-700 dark:text-slate-300 flex items-center gap-1">
